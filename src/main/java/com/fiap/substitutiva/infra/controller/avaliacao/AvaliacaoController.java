...
public class AvaliacaoController {
  ...
  //  private final BuscarAvaliacoesPorIdEstabalecimentoImpl buscarAvaliacoesPorIdEstabalecimento;
    ...
    public AvaliacaoDTO avaliarEstabelecimento(@RequestBody AvaliacaoDTO avaliacaoDTO) {
    ...
    public AvaliacaoDTO avaliarProfissional(@RequestBody AvaliacaoDTO avaliacaoDTO) {
        return new AvaliacaoDTO(
